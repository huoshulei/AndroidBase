...
public final class BadgeButton extends TextView {
    ...
    public BadgeButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        String     badgeText    = a.getString(R.styleable.BadgeButton_badgeText);
        int        badgeColor   = a.getColor(R.styleable.BadgeButton_badgeColor, 0xffFF4081);
        int        badgeHeight  = a.getDimensionPixelSize(R.styleable.BadgeButton_badgeHeight, (int) (getResources().getDisplayMetrics().density * 12));
        boolean    badgeVisible = a.getBoolean(R.styleable.BadgeButton_badgeVisible, false);
        a.recycle();
    ...
    public void setDrawableTop(int resId) {
        ...
        if (drawable != null) {
            ...
            setCompoundDrawables(drawables[0], drawable, drawables[2],
                    drawables[3]);
        }
    }
